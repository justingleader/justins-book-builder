...
![VS Code Preview Type Setting](https://quarto.org/docs/tools/images/vscode-preview-type.png)
...
*   The [Visual Editor](https://quarto.org/docs/tools/vscode-visual-editor.html) for WYSIWYG editing of `.qmd` documents.
*   The [Notebook Editor](https://quarto.org/docs/tools/vscode-notebook-editor.html) for editing `.ipynb` notebooks.
